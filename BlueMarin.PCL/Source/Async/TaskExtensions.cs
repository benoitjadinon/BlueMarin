...
namespace BlueMarin
{
	...
	public static class TaskExtensions {
		...
		//http://stackoverflow.com/questions/22338526/task-whenall-in-pcl
		/* TODO: depends on NitoEx, which adds the BCL...
		public static async Task TimeoutAfter(this Task task, int millisecondsTimeout = 1000)
		{
			if (task == await TaskEx.WhenAny(task, TaskEx.Delay(millisecondsTimeout))) 
				await task;
			else
